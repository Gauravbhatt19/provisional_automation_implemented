...
body{
  font-size:0.9em;
}</style><div style=' margin:-8px; border-bottom:1px solid #000; text-align:center;line-height:0.5rem;'>
<img height=100 style='padding-left:40px; position:fixed; left:-50px;' src='./logo.png'>
    <div style='margin-left:80px;'><img style='margin-bottom:10px; width:70%;' src='./hindi.png'><h2 >THDC Institute of Hydropower Engineering and Technology, Tehri</h2>
    <h3 style='margin-bottom:-5px; margin-top:-5px;'>Bhagirathipuram, Tehri Garhwal, 249124 Uttarakhand,India</h3>
...
<table cellspacing='0' cellpadding='5' border='1' style='width:100%; margin-top:20px;'>
...
<h3 style='text-align:center; text-decoration:underline;margin:0;'>Tabulation Mark Sheet of Semester 0".$sem." (Provisional)</h3>
<table cellspacing='0' cellpadding='5' border='1' style='width:100%; margin-top:10px;'>
  <tbody style='text-align:center;'>
    <tr><th rowspan='2'>S. No.</th>
    <th rowspan='2'>Subject</th>
    <th colspan='3'>Maximum Marks</th>
    <th colspan='3'>Marks Obtained</th>
    <th rowspan='2'>Result</th></tr>
    <tr>
      <th>Sem</th>
      <th>Ses</th>
      <th>Total</th>
