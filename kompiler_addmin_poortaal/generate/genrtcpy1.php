...
<body style="font-family: Calibri; font-size:0.8em; margin:0;">
  <header style="border-bottom:4px solid #000; text-align:center; display:grid;grid-template-columns:4fr 40fr; line-height:0.5rem;  ">
    <img height=100 style="padding-left:40px; "src="../../extra_resources/img/logo.png">
  ...
  <p style="font-weight:bolder; float :right; padding-right:50px;margin:0;">Date:<?php echo date("d/m/Y");?></p> <p style="font-weight:bolder; float :left; padding-left:50px;margin:0;">Ref. No.:<?php echo $id;?></p>
  <table cellspacing="0" cellpadding="5" style='margin-top:0;margin-bottom:-8px; '>
...
<h3 style="text-align:center; text-decoration:underline;">Tabulation Mark Sheet of Semester 0<?php echo $sem; ?> (Provisional)</h3>
...
<p style=" float:left; margin:-12px 80px; ">Note: While severe caution has been taken in compiling the data, even though if any case of error in statement of marks has been found, the marks entered in the tabulation chart of university / Institute shall be treated as correct and final.</p>
</div>
<a style='position:fixed; bottom:20px; left:35%; ' class='cus_but'  <?php echo "href='./genp.php?id=".$id."'";?> >Go Back</a>
<a style='position:fixed; bottom:20px; left:44%; ' class='cus_but' href="./print1.php" >Download</a>
<a style='position:fixed; bottom:20px; left:54%; ' class='cus_but' href="./gen1.php" >Generate & Send</a>
</body>
</html>