...
if(isset($_POST['type']))
{
	...
	if ( (isset($_POST['type'])) and (isset($_POST['password'])))
	{
		$_SESSION['type']=mysqli_escape_string($conn,$_POST['type']);
...
Instructions
  ...
  <ul class="list-group list-group-flush font-weight-bolder" >
    <li class='list-group-item'>Never Share admin Password to anyone.</li>
    <li class='list-group-item'>It is recommended to use Google Chrome Desktop Browser for this portal.</li>
     <li class='list-group-item'>Change Admin Password Periodically</li>
  </ul>
</div>
