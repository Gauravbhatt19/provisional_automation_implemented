...
if(isset($_SESSION['type']) and isset($_POST['1']))
{
...
<img height=100 style='padding-left:40px; position:fixed; left:-50px;' src='./logo.png'>
    <div style='margin-left:80px;'><img style='margin-bottom:15px; width:70%;' src='./hindi.png'><h3>THDC Institute of Hydropower Engineering and Technology, Tehri</h3>
